...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if app==7   %Kinematic Analysis of A Spatial Four-bar Mechanism model 1
...
%SJTd(:,k)=[t;i;j;sipr;sjpr;d;vxipr;vzipr;vxjpr;vzjpr]; 
    ...
    %si&jpr=vectors to Pi&j; d=dist.; vxipr, vzipr, vxjpr, vzjpr
SJDT(:,1)=[4;1;0;z3;z3;0;ux;uz;ux;uz];  %Rev. - Body 1 to Ground 
SJDT(:,2)=[4;3;0;[0;3.7;0];[-4;-8.5;0];0;[1;3.7;0];[0;2.7;0];[-4;-9.5;0];[-3;-8.5;0]];  %Rev. - Body 3 to Ground 
SJDT(:,3)=[6;1;2;[0;0;2];[0;6.1;0];0;[0.75;-0.662;2.0];[0.244;0.277;2.929];[0;6.1;1];6.1*uy];   %Univ. - Body 1 to 2
SJDT(:,4)=[2;2;3;-6.1*uy;-3.7*uy;0;[0;-6.1;1];-5.1*uy;[0;-3.7;1];-2.7*uy];   %Sph. - Body 2 to 3

%SMDT(4,nb): Mass Data Table (With diagonal inertia matrix) 
%SMDT=[[m1;J11;J12,J13],...,[mnb;Jnb1;Jnb2;Jnb3]]
SMDT=[[2;4;2;0],[1;12.4;0.01;0],[1;4.54;0.01;0]];
...
p10=[1;0;0;0];
r20=[-3.75;-4.25;4.25];
p20=[0.879;-0.29;-0.27;-0.26];
r30=[-5.75;-8.5;3.25];
p30=[0.607;-0.36;0.36;-0.61];
