...
integ=2;            %integ=1-Impl ODE Trap; integ=2-Impl ODE SDIRK54; 
...
hold on
plot(t,x2d,'DisplayName','x2d')
hold on
xlabel('Time [s]')
ylabel('x2,x2d')
yyaxis right
plot(t(2:end), BCondRat(2:end))
ylabel('BCond Condition Number')
title('K = 5000, C = 100, e10=3.5, integ=2-Impl ODE SDIRK54')
