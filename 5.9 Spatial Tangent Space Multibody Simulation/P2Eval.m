...
[P2ks1,P2ks2]=bbP2sph(i,j,s1pr,s2pr,tn,q,x,par);
[P2kd11,P2kd12]=bbP2dot1(i,j,vz1pr,vz2pr,tn,q,x,par);
P2k1=[P2ks1;P2kd11];
P2k2=[P2ks2;P2kd12];
...
[P2str11,P2str12]=bbP2dot2(i,j,vx1pr,s1pr,s2pr,tn,q,x,par);
[P2str21,P2str22]=bbP2dot2(i,j,vy1pr,s1pr,s2pr,tn,q,x,par);
...
[P2RS11,P2RS12]=bbP2dist(i,j,s1pr,s2pr,d,tn,q,x,par);
[P2RS21,P2RS22]=bbP2dot2(i,j,vz2pr,s1pr,s2pr,tn,q,x,par);
P2k1=[P2RS11;P2RS21];
P2k2=[P2RS12;P2RS22];
P2=Add(P2,P2k1,m,7*(i-1));
