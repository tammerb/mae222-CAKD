...
SJDT(:,2)=[4;3;0;[0;3.7;0];[-4;-8.5;0];0;-uy;ux;[-4;-9.5;0];ux];   %D Rev. - Body 3 to Ground
SJDT(:,3)=[6;1;2;[0;0;2];[0;6.1;0];0;[0.244;0.277;0.929];[0.75;-0.662;0];-uy;uz];   %B Univ. - Body 1 to 2
SJDT(:,4)=[2;2;3;[0;-6.1;0];[0;-3.7;0];0;uy;uz;uy;uz];   %C Spher. - Body 2 to 3
