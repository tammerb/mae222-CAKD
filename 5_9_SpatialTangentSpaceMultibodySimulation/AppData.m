...
%SJTd(:,k)=[t;i;j;sipr;sjpr;d;vxipr;vzipr;vxjpr;vzjpr]; 
    ...
    %6=Univ, 7=Strut, 8=Rev-Sph); i&j=bodies conn.,i>0;
    %si&jpr=vectors to Pi&j; d=dist.; vxipr, vzipr, vxjpr, vzjpr
SJDT(:,1)=[4;1;0;z3;z3;0;ux;uz;ux;uz];  %A Rev. - Body 1 to Ground
SJDT(:,2)=[4;3;0;[0;3.7;0];[-4;-8.5;0];0;[1;3.7;0];[0;2.7;0];[-4;-9.5;0];[-3;-8.5;0]];   %D Tran. - Body 1 to 2
SJDT(:,3)=[6;1;2;[0;0;2];[0;6.1;0];0;[0.75;-0.662;2.0];[0.244;0.277;2.929];[0;6.1;1.0];[0;6.1;0]];   %B Univ. - Body 1 to 2
SJDT(:,4)=[2;2;3;[0;-6.1;0];[0;-3.7;0];0;[0;-6.1;1];[0;-5.7;0];[0;-3.7;1];[0;-2.7;0]];   %C Spher. - Body 2 to 3
...
p10=[1;0;0;0];
r20=[-3.75;-4.25;4.25];
p20=[0.87944;-0.29;-0.27;-0.26];
r30=[-5.75;-8.5;3.25];
p30=[0.60687;-0.36;0.36;-0.61];
