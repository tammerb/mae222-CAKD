...
%PJTd(:,k)=[T;i;j;sipr;sjpr;d;vipr;vjpr]; k=joint No., 
    %T=joint type(1=Rev,2=Tran,3=Dist, 4=RotD), i&j=bodies conn.,
    %si&jpr=vectors to Pi&j, d=dist., vi&jpr=vectors along trans axis
PJDT(:,1)=[1;i1;j1;si1;sj1;d1;vi1;vj1];     %Rev-bod 1 to ground
PJDT(:,2)=[1;i2;j2;si2;sj2;d2;vi2;vj2];     %Rev-bod 2 to ground
PJDT(:,3)=[1;i3;j3;si3;sj3;d3;vi3;vj3];     %Rev-bod 3 to ground
PJDT(:,4)=[3;i4;j4;si4;sj4;d4;vi4;vj4];     %Dist.-bod 1 to bod 2
PJDT(:,5)=[3;i5;j5;si5;sj5;d5;vi5;vj5];     %Dist.-bod 2 to bod 3
PJDT(:,6)=[4;i6;j6;si6;sj6;d6;vi6;vj6];     %RotD-bod 1 to ground
